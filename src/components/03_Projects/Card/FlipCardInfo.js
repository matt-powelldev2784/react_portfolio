...
export const flipCardInfo = [
    {
        ...
        imgFront: otsLogo,
        imgBack: otsLogo,
        titleBack: 'Player Registration App',
    ...
    {
        title: 'Guess The Film Year',
        backgroundImg: filmYearBackGroundImage,
        imgFront: null,
        imgBack: filmYearLogo,
        titleBack: 'Guess The Film Year',
        text1: 'Guess the year game created using React, Styled Components and Redux ',
